...
enum Nivel { Facil, Medio, Dificil } <-- escolha aleatória enumerada 3 escolhas que o algoritmo irá fazer 

class Program
{
    static void Main(string[] args) <-- abrir inputs fixos aqueles que você faz aparecer e inputs para o usuário digitar
    {
        Random rng = new Random(); <-- método de esolha aleatória para o C# entender que esse método faz complementeo com o enum
